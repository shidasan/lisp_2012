...
#define TYPE_MASK ((uint64_t)0xFFFF000000000000)

#define INT_OFFSET = (((uint64_t)1) << 48)
#define FLOAT_OFFSET = (((uint64_t)2) << 48)
#define STRING_OFFSET = (((uint64_t)3) << 48)
#define SYMBOL_OFFSET = (((uint64_t)4) << 48)
#define T_OFFSET = (((uint64_t)5) << 48)
#define nil_OFFSET = (((uint64_t)6) << 48)
#define OPEN_OFFSET = (((uint64_t)7) << 48)
#define VARIABLE_TABLE_OFFSET = (((uint64_t)8) << 48)
#define LOCAL_ENVIRONMENT_OFFSET = (((uint64_t)9) << 48)
