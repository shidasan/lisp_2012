...
#define TODO(STR) fprintf(stderr, "(%s, %d)TODO: ", __FILE__, __LINE__); fprintf(stderr, (STR));
#define EXCEPTION(STR) fprintf(stderr, "(%s, %d)Exception!!: ", __FILE__, __LINE__);fprintf(stderr, (STR));
...
enum TokType {  tok_number, tok_plus, tok_minus, tok_mul, tok_div, tok_gt, tok_gte, tok_lt, tok_lte, tok_eq, tok_if, tok_defun, tok_str, tok_eof, tok_setq, tok_valiable, tok_func, tok_arg, tok_open, tok_close, tok_error, tok_nil, tok_T, tok_symbol, tok_dot};
