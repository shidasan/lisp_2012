...
typedef struct static_mtd_data {
	...
	int is_quote1;
	val_t (*mtd)(val_t*, int);
	val_t (*special_mtd)(val_t*, array_t*);
} static_mtd_data;
...
func_t* set_static_func (static_mtd_data *data);
